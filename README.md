# Chessbot [![Cult Of Martians][cult-img]][cult]


<p align="center">
  <img src = "https://github.com/Ceimtun-RAS/chessbot-controller/blob/docs/docs/assets/kinovaGen3_lite_rviz.gif" width = "30%" />  
</p>

Automatic Serial Manipulator algorithm for KinovaGen3. Ceimtun-RAS. The _RaspberryPi_ uses __Ubuntu Server 20.04 LTS__, connected via __SSH__. Uses `ros noetic`. 
